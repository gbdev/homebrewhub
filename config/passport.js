...
module.exports = function(passport) {
    ...
    passport.use('local-signup', new LocalStrategy({
        ...
        function(req, email, username, password, done) {
            if (!email)
                return done(null, false, req.flash('signupMessage', 'You need a valid email address to register'));
            if (!username)
                return done(null, false, req.flash('signupMessage', 'Choose a username to create the account.'));
            if (email)
                email = email.toLowerCase(); // Use lower-case e-mails to avoid case-sensitive e-mail matching
